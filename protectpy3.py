...
#Khusus Lpgin Token
cl = LINE(token="EsUJMqmIRlae18qzhdTf.mI1RpayCqsKCxVJ9avXsFW.WGb/MGEcqRG1dgYP/7ayl8pBwIxjg4kZxztPzsDW8sk=")
cl.log("Auth Token : " + str(cl.authToken))
cl.log("Timeline Token : " + str(cl.tl.channelAccessToken))
...
► Command in the groups By Lurah ►
► Tutup qr
► Buka qr
► Invite 「Mid」
► Invite 「Mid」
...
Bots=[mid]
admin=["u322d6b3c061c41291c5ef8fd015c527f"]
wait = {
    'contact':False,
    'autoJoin':True,
    ...
    'timeline':True,
    'autoAdd':False,
    'message':"Thanks for add me \n Creator http://line.me/ti/p/xEzlwiJeFr",
    "lang":"JP",
